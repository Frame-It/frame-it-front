...
export default function LeavePage() {
  ...
  return (
    <main className="relative flex h-[calc(100dvh-78px)] flex-col justify-between px-4 xl:h-[calc(800px-78px-24px)]">
      <div>
        <section className="mt-[20px]">
          <ul className="left-[150%] list-disc space-y-[2px] rounded-[8px] bg-caution px-[12px] py-[10px] text-xs text-gray-20">
            ...
            <li className="ml-[12px]">
              ...
              삭제되어 작성자 본인을 확인할 수 없습니다. 삭제를 원하시면 탈퇴
              전에 직접 삭제 부탁드립니다.
            </li>
          </ul>
...
고객님의 소중한 피드백을 반영하여 더 나은 프레이밋이 되겠습니다.
      ...
      <Button
        disabled={!isChecked}
        className="bottom-0 left-0 mb-[9px] w-full"
        size="lg"
